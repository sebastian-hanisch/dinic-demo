...
Seine eigenen Schwächen sind die Ansatzpunkte der nächsten: Fluss wird weiter über Wege gebaut (**Push-Relabel**), und die Kosten entscheiden nicht (**Successive Shortest Paths**). Bisher gebaut: die Wurzel und dieses Stück.
```
