...
SETTING_SPECS = {
    ...
    "blocking_radio": SettingSpec("blocking", _choice(C.BLOCKING_LABELS), C.DEFAULT_BLOCKING),
...
PRESET_KEYS = {"net": "net_select", "blocking": "blocking_radio", "p": "p_slider", "d": "d_slider", "s": "s_slider", "density": "density_slider",
